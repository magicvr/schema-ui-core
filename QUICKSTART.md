...
> 注：`schema-ui create` 生成骨架钉在 API tag 时刻的包面（当前 = apps/api/v0.6.0 包面：protocol 0.2.15 · lib 0.1.14 · renderer 0.3.13 · ui 0.1.11 · shell 0.1.6 · theme 0.1.4）；`schema-ui upgrade` 会把 Go/npm 依赖拉到最新（registry 语义 · 零冲突）。
