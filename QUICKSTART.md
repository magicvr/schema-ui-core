...
> 注：`schema-ui create` 生成骨架钉在 API tag 时刻的包面（当前 = apps/api/v0.7.1 包面：protocol 0.2.17 · lib 0.1.16 · renderer 0.3.15 · ui 0.1.13 · shell 0.1.7 · theme 0.1.4）；`schema-ui upgrade` 会把 Go/npm 依赖拉到最新（registry 语义 · 零冲突）。
