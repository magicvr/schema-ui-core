...
func TestBuiltinProfilesResolveDeterministically(t *testing.T) {
	...
	if got, want := mvp.Modules, []string{"core.server-registration", "core.auth-session", "core.manifest-route", "core.navigation-capability", "core.schema-render", "core.operationlog", "admin.users", "admin.roles", "admin.account", "admin.dashboard"}; !reflect.DeepEqual(got, want) {
	...
	if got, want := plan.IDs(), []string{"core.server-registration", "core.auth-session", "core.schema-render", "core.manifest-route", "core.navigation-capability", "core.operationlog", "admin.account", "admin.dashboard", "admin.roles", "admin.users"}; !reflect.DeepEqual(got, want) {
	...
	if got, want := demo.Modules, []string{"core.server-registration", "core.auth-session", "core.manifest-route", "core.navigation-capability", "core.schema-render", "core.operationlog", "admin.users", "admin.roles", "dev.examples", "admin.account", "admin.dashboard"}; !reflect.DeepEqual(got, want) {
