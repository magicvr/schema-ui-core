...
func BuiltinModules() []Module {
	return []Module{
		...
		{ID: "admin.account", Version: "2.0.0", KernelAPIRange: ">=2.0 <3.0", DependsOn: []string{"core.auth-session", "core.navigation-capability", "core.schema-render", "core.operationlog"}, Requires: StandardAdminCapabilities(), Contributions: ContributionKeys{Routes: []string{"GET /api/account/profile", "PATCH /api/account/profile", "POST /api/account/avatar", "GET /api/account/avatars/{id}", "POST /api/account/password", "GET /api/account/sessions", "POST /api/account/sessions/{id}/revoke", "POST /api/account/sessions/revoke-others", "POST /api/users/{id}/enable", "POST /api/users/{id}/disable", "POST /api/users/{id}/unlock"}, Pages: []string{"account"}, Navigation: []string{"menu_account"}, Permissions: []string{"users.enable", "users.disable"}, Fragments: []string{"account"}}},
		...
		{ID: "admin.scheduled-tasks", Version: "2.0.0", KernelAPIRange: ">=2.0 <3.0", DependsOn: []string{"core.auth-session", "core.navigation-capability", "core.schema-render", "core.operationlog"}, Requires: StandardAdminCapabilities(), Contributions: ContributionKeys{Routes: []string{"GET /api/scheduled-tasks", "GET /api/scheduled-tasks/{id}", "GET /api/scheduled-tasks/handlers", "POST /api/scheduled-tasks", "PATCH /api/scheduled-tasks/{id}", "DELETE /api/scheduled-tasks/{id}", "POST /api/scheduled-tasks/batch-delete", "POST /api/scheduled-tasks/{id}/run", "GET /api/scheduled-tasks/{id}/runs", "GET /api/task-runs", "GET /api/task-runs/{id}"}, Pages: []string{"scheduled-tasks", "task-runs"}, Navigation: []string{"menu_scheduled_tasks"}, Permissions: []string{"tasks.read", "tasks.write"}, Fragments: []string{"scheduled-tasks"}}},
