...
var frozenLiteralCodes = []string{
	...
	// VP-033 R3 C3: Telegram operator console and outbound state machine.
	"TELEGRAM_OPERATOR_UNAVAILABLE", "TELEGRAM_CAPABILITY_UNAVAILABLE", "TELEGRAM_CHAT_NOT_FOUND", "TELEGRAM_REQUEST_NOT_FOUND",
	"TELEGRAM_REQUEST_IN_PROGRESS", "TELEGRAM_REQUEST_CONFLICT", "TELEGRAM_RETRY_NOT_ALLOWED", "TELEGRAM_SEND_FAILED",
	// VP-031 R2 (workspace-031 GOAL-002 D-002 v1.0.0 §9): biz.digital-offer
	// codes; INVALID_BIZOFFER_REQUEST added via GOAL-003 D-001 addendum.
	"BIZOFFER_NOT_FOUND", "BIZOFFER_NOT_ON_SALE", "BIZOFFER_CURRENCY_MISMATCH", "BIZOFFER_INSUFFICIENT_FUNDS",
	"BIZOFFER_SUBJECT_NOT_FOUND", "BIZOFFER_ENTITLEMENT_INSUFFICIENT",
	"BIZOFFER_REQUEST_CONFLICT", "BIZOFFER_FORM_CONFLICT", "BIZOFFER_VERSION_CONFLICT", "INVALID_BIZOFFER_REQUEST",
}
