...
| canonical_scope | `docs/workspace-007-localization-and-system-settings/` | 本审计仅读该范围 + 愿景链（VP/Charter 对齐） |
...
| 材料 | 路径 |
|------|------|
| 工作区 | `docs/workspace-007-localization-and-system-settings/workspace.md` |
| 目标树 | `…/goal-tree.md` |
