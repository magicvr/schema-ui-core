...
```text
GOAL-001-localization-and-system-settings [active] (1/6)
└── GOAL-002-s1-locale-core [active] (0/5)
```
...
|----|------|--------|--------|----------|---------|
| GOAL-001-localization-and-system-settings | 多语种与系统设置产品化 | `null` | **active** | `1/6` | 2026-08-09 |
| GOAL-002-s1-locale-core | S1 · 多语种核心（locale 解析/资源/切换/格式化） | GOAL-001-localization-and-system-settings | **active** | `0/5` | 2026-08-09 |
...
- 纲领路线图 S0–S5 见 Root `00-meta.md`；`progress: 1/6` 由 6 个阶段检查点等权派生（P-001），仅展示，不放行阶段、不关闭 finding。
...
- **S1** 由 `GOAL-002-s1-locale-core` 承接（2026-08-09 开设，五件套齐备，D-001 冻结实施范围）。
