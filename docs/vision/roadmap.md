...
Admin 功能当前拍：**[VP-029-wallet-prepaid-instrument](plans/VP-029-wallet-prepaid-instrument.md) `active`**（2026-09-02 激活 · 钱包预付资金凭证 + 外部主体接缝；扩展 `admin.wallet`，不重开 VP-011，不是支付域；VRev-066 independent `pass`；lead `workspace-029-wallet-prepaid-instrument`）。VP-030/031 仍 `planned`，硬前置本 VP。体验增强（全局搜索 / Command Palette）仍登记、不插队。
