...
| 40 | [VP-040-timestamptz-persistence-contract](plans/VP-040-timestamptz-persistence-contract.md) | 架构 · **C1 DB 时间列 timestamptz 持久化合同**（`RES-T03-tz` / `RT-T03`）：PG `timestamptz(6)` + SQLite fixed-6 UTC RFC3339 `TEXT`，全部绝对时刻列进入分母，双方言各自原地转换；公共时间 wire 统一 6 位微秒 RFC3339 UTC `Z`；不引入 ORM/第三库或 SQLite→PG 产品搬运器。 | 继承 VP-013 双方言端口/checksum 台账、VP-020 展示/输入时区合同、VP-035 评估；VP-039 波次已 `closed`；与 VP-009/010 正交；不消耗 A3/Redis/MQ | **active**（2026-09-20 · v0.2.1 · lead: workspace-040-timestamptz-persistence-contract；R1 用户裁决已落盘，逐列证据由 GOAL-002 承接） |
