...
| 31 | [VP-031-digital-offer-entitlement](plans/VP-031-digital-offer-entitlement.md) | 业务域 · **数字 Offer + 薄购买凭证 + 权益**（本仓首个业务域 VP）。服务视为可售 Offer，不是电商类目/SKU/税/库存/物流订单。 | VP-029 硬前置已满足；H-002 同进程书面确认；RT-Q03/Q05 均评估为本波不需要 Redis；R1 required 信息未冻结前不得进入 R2 | **active**（2026-09-05 · v0.3.3 · 第 3 次关门撤回：A-012 `conditional` 2 required → D-004 fixed ×2 + A-013 closed ×2，待 focused independent closure 复审后重新关门 · lead `workspace-031-digital-offer-entitlement` · Root `active · 3/4`，R1～R3 关门、R4 重开） |
...
**当前组合焦点**：active 交付 VP = **[VP-031](plans/VP-031-digital-offer-entitlement.md)**（业务域 · 数字 Offer 与权益；2026-09-05 v0.3.3，第 3 次关门撤回——A-012 `conditional` 2 required 已由 D-004/A-013 闭合，待 focused independent closure 复审后重新关门；lead `workspace-031-digital-offer-entitlement`，Root `active · 3/4`，R1～R3 关门、R4 重开）。VP-029 硬前置已满足；VP-030/032/033 均 `closed`；RT-Q03/Q05 激活评估均为本波不需要 Redis。持续程序 VP-009/010 照常；体验增强不插队。其余已关闭 VP 与历史证据继续以各计划和工作区台账为准。
