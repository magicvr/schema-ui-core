...
**当前组合焦点**：VP-001～**007** 均 **closed**；**[VP-008](plans/VP-008-admin-module-readiness-and-foundation-convergence.md)** 为 `active`、0 workspace，2026-08-10 起进入 §5.1 的 14 日空转宽限，尚未产生 `go`。当前无 active 交付 VP（VP-008 尚未绑定 delivery workspace）。协议覆盖权威 `I-PROTO-FULL-001`；订单/钱包/类目/通知仍是后续独立业务 VP 候选，并受 VP-008 `go` 门闩约束。
