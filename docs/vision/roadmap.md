...
**当前组合焦点**：active 交付 VP = **[VP-031](plans/VP-031-digital-offer-entitlement.md)**（业务域 · 数字 Offer 与权益；2026-09-05 VRev-080 self `pass`；lead `workspace-031-digital-offer-entitlement`，Root `active · 0/4`）。VP-029 硬前置已满足；VP-030/032/033 均 `closed`；RT-Q03/Q05 激活评估均为本波不需要 Redis。持续程序 VP-009/010 照常；体验增强不插队。其余已关闭 VP 与历史证据继续以各计划和工作区台账为准。
