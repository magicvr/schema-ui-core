...
- **现行组合投影（2026-09-18）**：**当前无 active 交付 VP**。最近关门 = **[VP-037-admin-workflow-continuity](plans/VP-037-admin-workflow-continuity.md)**（closed v1.7.0；lead `workspace-037-admin-workflow-continuity`；用户书面确认 · VRev-096 self `pass`；Root `GOAL-001-admin-workflow-continuity` **done · 6/6**）。其前最近关门 = **[VP-036-admin-command-palette](plans/VP-036-admin-command-palette.md)**（closed v0.3.0；lead `workspace-036-admin-command-palette`；VRev-093 self `pass`；Root `GOAL-001-admin-command-palette` done 4/4）。持续程序 VP-009/VP-010 与已关闭 VP 的历史绑定不变；不改变 Charter `primary_workspace`。
- **2026-09-18 组合投影（editorial · 关门）**：**[VP-037-admin-workflow-continuity](plans/VP-037-admin-workflow-continuity.md) 已 `closed` v1.7.0** —— lead `workspace-037-admin-workflow-continuity`（Root `GOAL-001-admin-workflow-continuity` **`done · 6/6`**；R1～R6 全部完成；非纲领整改子目标 GOAL-008/009/010/011 均 done 4/4；用户书面确认 · VRev-096 self `pass` · open required = 0）。**当前组合无 active 交付 VP**；最近关门即 VP-037（2026-09-18），其前为 **[VP-036-admin-command-palette](plans/VP-036-admin-command-palette.md)**（closed v0.3.0；VRev-093 self `pass`；Root `GOAL-001-admin-command-palette` done 4/4）。残余 `V-F124`、`R5-I-005`、`I-037-005`、`GOAL-008 A-002 F-002`、`GOAL-009 A-001 F-001-F-002` 保持开放；实体全文检索 / `RT-X01`/`RT-X02`、批量结果中心、组织·部门·岗位与 `org` 数据权限、新业务域、Redis/MQ/多实例保持 gated。持续程序 VP-009/VP-010 与已关闭 VP 的历史绑定不变；该投影不改变 Charter 0.4.0 的 strategic 目的、边界或非目标，也不改变 `primary_workspace`。
