...
- **当前组合焦点**：[VP-007](plans/VP-007-localization-and-system-settings.md) 已 **`closed`**（2026-08-09 用户书面确认；v0.3.0；lead `workspace-007-localization-and-system-settings` / Root `GOAL-001-localization-and-system-settings` `done 6/6`，后续 S6 增量亦已关闭）。[VP-005](plans/VP-005-design-system-and-ui-experience.md) 已 **`closed`**；协议覆盖权威 = **`I-PROTO-FULL-001`**（[VP-006](plans/VP-006-full-protocol-contract-v2-7-0.md) **closed**，2026-08-08；12/12 include，320 case = 318 executed + 2 local adapter excluded）。VRev-011/015/016 findings 均已 **fixed**。[VP-008](plans/VP-008-admin-module-readiness-and-foundation-convergence.md) 已 **`closed`**（2026-08-10 用户书面确认；候选 `ed99e88`、`go` 签发、解锁后续标准业务模块实现；lead `workspace-008-admin-module-readiness` / Root `GOAL-001-admin-module-readiness` done 6/6）。**[VP-013-store-dialects](plans/VP-013-store-dialects.md) 已于 2026-08-21 有界 `closed`**（v0.3.0；架构 A1；lead `workspace-013-store-dialects` / Root `GOAL-001-store-dialects` `done 5/5`；VRev-030 `pass`，V-F060 → `fixed`；residual = 无产品 SQLite→PG 搬运器）。**当前交付 VP** = [VP-014-object-storage](plans/VP-014-object-storage.md)（2026-08-21 `active` v0.2.0；架构 A2；lead `workspace-014-object-storage` / Root `GOAL-001-object-storage`；VRev-031 `pass`，V-F061/V-F062 → `fixed`）。[VP-012](plans/VP-012-shared-cross-module-contracts.md) 已于 2026-08-19 **完整 `closed`**。[VP-011](plans/VP-011-admin-functional-modules.md) 已于 2026-08-18 有界 `closed`。后续方向按 [roadmap.md](roadmap.md) **架构 / Admin 功能 / 业务域** 三分支并行登记。持续程序仍为 [VP-009](plans/VP-009-production-hardening.md) 与 [VP-010](plans/VP-010-design-implementation-conformance.md)。后续订单/钱包/类目/通知等业务 VP 候选激活前须完成消费前 freshness review。
