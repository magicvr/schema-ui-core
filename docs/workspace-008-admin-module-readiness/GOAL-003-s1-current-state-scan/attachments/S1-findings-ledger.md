...
- **证据**：
  - `docs/workspace-005-full-protocol-contract-v2-7-0/GOAL-001-full-protocol-contract-v2-7-0/attachments/I-PROTO-FULL-001-coverage-v2-7-0.md:30,60,80,112` — 「无 exclude / exclude 0 / 37/37 全绿 / 320/320 全绿」
