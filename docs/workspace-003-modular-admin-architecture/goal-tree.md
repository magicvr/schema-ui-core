...
GOAL-013-r6-old-path-removal [active] (0/4) · R6 旧路径移除与终态验收
```
...
| GOAL-013-r6-old-path-removal | R6 旧路径移除与终态验收 | `GOAL-001-modular-admin-architecture` | active | `0/4` | 2026-08-05 |
