...
└── GOAL-008-r5-engineering-fork [active] R5 · 工程化、fork 体验与集成关门 (0/5)
```
...
| `GOAL-008-r5-engineering-fork` | R5 · 工程化、fork 体验与集成关门 | `GOAL-001-production-admin-foundation` | `active` | `0/5` | 2026-08-02 |
