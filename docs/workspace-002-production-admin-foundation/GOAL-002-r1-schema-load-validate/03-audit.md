...
- 当前工作区为 `workspace-002-production-admin-foundation`，canonical root 为 `docs/workspace-002-production-admin-foundation/`，Root 为 `GOAL-001-production-admin-foundation`；目标 parent、goal-tree 与工作区绑定一致。
