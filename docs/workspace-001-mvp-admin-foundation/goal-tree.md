...
|----|-------|--------|--------|----------|---------|
| GOAL-001-mvp-admin-foundation | MVP Admin 基架 | null | active | 2/6 | 2026-07-31 |
...
- Root `progress: 2/6` = 纲领路线图 R1–R6 中 R1、R2 已完成（等权派生）；**不**放行 R3-R6、不关闭 finding、不推导 Root `done`。
