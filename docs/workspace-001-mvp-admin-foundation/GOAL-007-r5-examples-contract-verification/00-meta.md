...
|----|------|-----------------|----------|--------------|-----------------|------|-------------|-------------|
| I-007-001 | required | 每条纳入能力的范例页路径与自动化/手工验证入口？ | R5 验收 / 关门 | R5 验收前 | 对照 [I-PROTO-001 v0.1.3] §3 与协议清单 §2.5，登记每纳入域的范例路径与验证命令/步骤 | **verified** | 2026-07-31 R5 阶段 1 完成：登记表落盘并已核验复用产物命令；执行验证仍属阶段 3（I-007-001 只确认登记，不确认逐域验证已执行） | [attachments/I-007-001-registry.md](attachments/I-007-001-registry.md) v0.1.0 |
