...
```text
GOAL-001-event-bus-port (进程内事件总线端口 · active · 1/4)
└── GOAL-002-r1-contract-freeze (R1 契约冻结 · done · 3/3) ✅ R1 关门（2026-09-01 双审 pass）
（R1 ✅ → R2 进程内实现 → R3 接缝与对齐 → R4 证据与关门）
```
...
|----|-------|--------|----------|--------|-------|
| GOAL-001-event-bus-port | 进程内事件总线端口 | active | 1/4 | null | R1 已关门；I-028-001/002/003 verified；I-028-004 required 待 R3；判据 #1/#6 冻结 |
