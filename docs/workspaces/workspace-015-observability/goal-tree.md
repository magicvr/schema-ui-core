...
> Root：`GOAL-001-observability`（**active** · 4/5）
...
└── GOAL-006-dual-path-evidence [active]    · R5 双路径证据与 Root 关门准备（证据收集中）
```
...
| GOAL-006-dual-path-evidence | R5 · 双路径证据与 Root 关门准备 | GOAL-001-observability | active | 0/4 | 2026-08-22 |
