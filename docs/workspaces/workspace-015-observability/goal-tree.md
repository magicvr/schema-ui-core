...
> Root：`GOAL-001-observability`（**active** · 2/5）
...
R3～R5 子目标按纲领串行，待前序阶段收口后逐段立项。下一阶段：R3 OpenTelemetry traces 接入（I-002 required 须在 R3 方案冻结前闭合）。

## 状态表

| id | title | parent | status | progress | updated |
|----|-------|--------|--------|----------|---------|
| GOAL-001-observability | 可观测性（指标导出 + OpenTelemetry） | null | active | 2/5 | 2026-08-21 |
