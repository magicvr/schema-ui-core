...
- **Root** `GOAL-001-telegram-channel-runtime`：`active` · **3/4**（R1 合同冻结 **已关门** GOAL-002 3/3 → R2 webhook+分发+身份 **已关门** GOAL-003 3/3 → R3 出站+设置+限流核账 **已关门** GOAL-004 3/3 → R4 证据与关门 **进行中**），纲领见 Root `00-meta.md`。
...
| Root Goal | `GOAL-001-telegram-channel-runtime` | `parent: null`；active · 3/4（R1/R2/R3 已关门） |
...
| R4 | **证据与关门**（判据 7/8）：证据矩阵 / 越界核账 / 审计闭合 | **进行中**（待立项 GOAL-005） |
