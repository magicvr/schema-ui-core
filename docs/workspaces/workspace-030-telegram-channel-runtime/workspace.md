...
- **Root** `GOAL-001-telegram-channel-runtime`：`active` · **2/4**（R1 合同冻结 **已关门** GOAL-002 3/3 → R2 webhook+分发+身份 **已关门** GOAL-003 3/3 → R3 出站+设置+限流核账 **进行中** → R4 证据与关门），纲领见 Root `00-meta.md`。
...
| Root Goal | `GOAL-001-telegram-channel-runtime` | `parent: null`；active · 2/4（R1/R2 已关门） |
...
| R3 | **出站 + 设置 + 限流核账**（判据 3/5 + I-030-005）：SendMessage mock/生产供应商隔离 · Admin bot tab · 入站限流核账 | **进行中**（待立项 GOAL-004） |
