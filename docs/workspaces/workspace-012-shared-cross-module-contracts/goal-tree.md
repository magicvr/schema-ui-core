...
└── GOAL-009-audit-envelope-and-session [done]              · R8 审计 envelope 全覆盖与 session 关联
```
...
| GOAL-009-audit-envelope-and-session | R8 · 审计 envelope 全覆盖与 session 关联 | GOAL-001-shared-cross-module-contracts | done | 100%（3/3） | 2026-08-19 |
