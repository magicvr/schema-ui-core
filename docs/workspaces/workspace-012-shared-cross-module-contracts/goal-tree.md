...
> Root：`GOAL-001-shared-cross-module-contracts`（**交付目标 · active**；R1–R7 子目标均 done，Root 关门审计未做）
> primary_plan：`VP-012-shared-cross-module-contracts`（**closed** · 首波；R7 为关门后增量）
...
├── GOAL-007-r6-api-token-service-credential [done]          · R6 API Token / Service Credential
└── GOAL-008-audit-log-retention-settings [done]            · R7 审计日志保留设置与过期归档/删除
```
...
|----|-------|--------|--------|----------|---------|
| GOAL-001-shared-cross-module-contracts | 共享横切契约与平台基架（分波交付） | null | active | 100%（7/7） | 2026-08-19 |
...
| GOAL-007-r6-api-token-service-credential | R6 · API Token / Service Credential | GOAL-001-shared-cross-module-contracts | done | 100%（4/4） | 2026-08-19 |
| GOAL-008-audit-log-retention-settings | R7 · 审计日志保留设置与过期归档/删除 | GOAL-001-shared-cross-module-contracts | done | 100%（3/3） | 2026-08-19 |
