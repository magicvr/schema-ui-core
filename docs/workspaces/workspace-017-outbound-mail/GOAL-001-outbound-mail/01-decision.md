...
|----|------|-----------------|----------|--------------|-----------------|------|-------------|-------------|
| I-001 | required | 默认 sink 形态与取报文 | R1 方案 | R1 冻结 | R1 决策 | collecting | — | VP I-017-003 |
| I-002 | required | Send To 基数 | R1 方案 | R1 冻结 | R1 决策 | collecting | — | VP I-017-004 |
| I-003 | required | STARTTLS vs 隐式 TLS | R2 方案 | R2 接入前 | R2 决策 | collecting | — | VP I-017-001 |
| I-004 | required | 配置键名与凭证注入 | R2 方案 | R2 接入前 | R2 决策 | collecting | — | VP I-017-002 |
