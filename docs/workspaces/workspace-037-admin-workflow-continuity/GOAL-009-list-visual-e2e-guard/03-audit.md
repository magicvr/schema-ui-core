...
|------|------|--------|-------|---------|---------------|------|
| A-001 | 2026-09-18 | self | GOAL-009 C1-C4：列表视觉浏览器级守卫的范围、实现、双 profile 回归与变异验证 | pass | 无（F-001/F-002 recommended） | [A-001-goal009-self-closeout.md](03-audit/A-001-goal009-self-closeout.md) |
...
`A-001 F-001`（未断言暗色下开关实际底色）与 `F-002`（仅覆盖 roles 单页）为 recommended 保持 open，不阻断关门。
