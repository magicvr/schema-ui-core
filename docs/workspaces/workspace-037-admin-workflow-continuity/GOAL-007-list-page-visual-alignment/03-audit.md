...
| A-002 | 2026-09-18 | self | R6 C5/C7/C8 实现、回归与治理投影 | conditional | 无未处置（F-001/F-002/F-004 fixed；F-005 跨区部分按用户裁决移交 GOAL-008） | [A-002-r6-revision-audit.md](03-audit/A-002-r6-revision-audit.md) |
...
verdict 维持 `conditional`：F-005 的移交不等于闭合（P-003 要求 `fixed` 须可核对修正），其闭环待 `GOAL-008` 的 C3/C4 完成。因此 R6 保持 `active · 7/8`，完成投影待 `GOAL-008` 处置落定后单独执行。R6 不改变 R5 的 `R5-I-004` 用户书面关门门禁，Root/VP 保持 `active`。
