...
- Root `[workspace-037-admin-workflow-continuity] GOAL-001-admin-workflow-continuity`：**`active · 2/5`**；R1、R2 已完成，R3～R5 仍按路线推进。
...
| Root Goal | `GOAL-001-admin-workflow-continuity` | `parent: null`；**active · 2/5** |
...
- VP：[VP-037-admin-workflow-continuity](../../vision/plans/VP-037-admin-workflow-continuity.md)（**`active` · v0.5.0**）
...
| R3 | 未保存变更保护与离开确认状态机 | **active via `GOAL-004-r3-unsaved-change-protection` · 0/4**；承接 D-004 与 `39c744ef` dirty-state 基础切片 |
