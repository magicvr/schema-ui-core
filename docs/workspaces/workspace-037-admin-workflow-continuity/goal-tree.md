...
└── GOAL-005-r4-unified-feedback-recovery [active · 0/4]
```
...
R1 分母与语义冻结 [done · GOAL-002 · 3/3]
  → { R2 Saved Views [done · GOAL-003 · 4/4]
      ...
      R4 统一反馈与恢复 [active · GOAL-005 · 0/4] }
  → R5 组合验收与关门 [pending]
```
...
| GOAL-005-r4-unified-feedback-recovery | R4 统一反馈与恢复 | **active** | 0/4 | GOAL-001-admin-workflow-continuity | 承接 R1 D-005 反馈/恢复合同；先补跨表面错误分类、读重试安全边界、写失败保留与无障碍证据 |
