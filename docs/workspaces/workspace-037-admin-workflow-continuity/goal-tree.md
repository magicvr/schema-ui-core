...
```text
GOAL-001-admin-workflow-continuity [active · 4/5]
...
|----|-------|--------|----------|--------|-------|
| GOAL-001-admin-workflow-continuity | Admin 工作流连续性与安全反馈交付 | **active** | 4/5 | null | R1/R2/R3/R4 子目标分别 done 3/3、4/4、4/4、4/4；I-037-001～004 verified；R1/R2/R3/R4 self+independent pass；I-037-006 verified；Vision open required = 0；R5 `GOAL-006` active 3/4 |
...
- Root `progress: 4/5` 由 `00-meta.md` 的 5 个显式纲领检查点派生；它只表示阶段检查点展示，不放行方案、实施、验收或关门。
