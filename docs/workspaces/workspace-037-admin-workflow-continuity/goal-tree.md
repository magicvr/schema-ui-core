...
> Root：`GOAL-001-admin-workflow-continuity`（**active · 3/5**）
> primary_plan：`VP-037-admin-workflow-continuity`（active · v0.6.0）

## 目标树

```text
GOAL-001-admin-workflow-continuity [active · 3/5]
...
└── GOAL-005-r4-unified-feedback-recovery [active · 3/4]
```
...
R1 分母与语义冻结 [done · GOAL-002 · 3/3]
  → { R2 Saved Views [done · GOAL-003 · 4/4]
      ...
      R4 统一反馈与恢复 [active · GOAL-005 · 3/4] }
  → R5 组合验收与关门 [pending]
```
...
|----|-------|--------|----------|--------|-------|
| GOAL-001-admin-workflow-continuity | Admin 工作流连续性与安全反馈交付 | **active** | 3/5 | null | R1/R2/R3 子目标分别 done 3/3、4/4、4/4；I-037-001～004 verified；R1/R2/R3 self+independent pass；I-037-006 verified；Vision open required = 0 |
...
| GOAL-005-r4-unified-feedback-recovery | R4 统一反馈与恢复 | **active** | 3/4 | GOAL-001-admin-workflow-continuity | C1～C3 已完成并通过 self；C4 待本地 Grok independent 意见响应与 Git checkpoint |

## 维护说明

- Root `progress: 3/5` 由 `00-meta.md` 的 5 个显式纲领检查点派生；它只表示阶段检查点展示，不放行方案、实施、验收或关门。
