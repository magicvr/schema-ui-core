...
| I-037-002 | required | Saved View 所有权、持久化、序列化、失效 | R1 / R2 | R1 | API/存储/用户边界对照与用户决策；R2 验证实现 | verified | 2026-09-17 R1 信息冻结；R2 完成后复核实现证据 | `GOAL-002.../01-decision/D-003-saved-view-localstorage-accepted.md` |
