...
| A-002 | 2026-09-18 | self | 跨区勘误执行复核 ＋ 守卫对 `-p <solution-style config>` 的覆盖度 | conditional | 无（F-001/F-002 recommended） | [A-002-goal008-errata-and-guard-gap.md](03-audit/A-002-goal008-errata-and-guard-gap.md) |
