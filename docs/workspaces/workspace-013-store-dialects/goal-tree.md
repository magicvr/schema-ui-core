...
> Root：`GOAL-001-store-dialects`（**active**；R1–R5 4/5）
...
└── GOAL-006-r5-dual-path-acceptance [active]· R5 双路径验收（升级策略 + 备份合同 + 全链证据）
```
...
|----|-------|--------|--------|----------|---------|
| GOAL-001-store-dialects | Store 双方言（PostgreSQL 生产权威 + SQLite 内嵌） | null | active | 4/5 | 2026-08-20 |
...
| GOAL-006-r5-dual-path-acceptance | R5 · 双路径验收（升级策略 + 备份合同 + 全链证据） | GOAL-001-store-dialects | active | — | 2026-08-20 |
