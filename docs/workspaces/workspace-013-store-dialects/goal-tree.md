...
> Root：`GOAL-001-store-dialects`（**active**；R1–R5 2/5）
...
└── GOAL-004-r3-dual-dialect-ledger [active]· R3 双方言台账对写（compiled catalog 两方言 apply + checksum）
```
...
| GOAL-004-r3-dual-dialect-ledger | R3 · 双方言台账对写（compiled catalog 两方言 apply + checksum） | GOAL-001-store-dialects | active | 3/5 | 2026-08-20 |
