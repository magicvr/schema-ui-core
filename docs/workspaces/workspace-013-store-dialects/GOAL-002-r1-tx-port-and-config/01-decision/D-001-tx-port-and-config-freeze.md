...
- **后续**：R1 自审关门。合同已被 [D-002](D-002-a002-freeze-patch.md) 升为 v1.1、[D-003](D-003-a004-freeze-patch.md) 升为 **v1.2**；R2 按 v1.2 实施，勿按本条原文的 v1.0 或 v1.1 猜测时间单位 / `Open` vs catalog。
