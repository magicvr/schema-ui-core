...
```text
GOAL-001-timezone-number-currency-formatting [active 3/4]  · 时区 / 数字 / 货币格式语义
...
|----|-------|--------|--------|----------|---------|
| GOAL-001-timezone-number-currency-formatting | 时区 / 数字 / 货币格式语义 | null | active | 3/4 | 2026-08-26 |
