...
- **Root** `GOAL-001-timezone-number-currency-formatting`：**`active`** · 0/4（R1～R4 未立项）。
...
| Root Goal | `GOAL-001-timezone-number-currency-formatting` | `parent: null`；**active** · 0/4（R1～R4 未立项） |
...
| 阶段 | 内容 | 状态 |
|------|------|------|
| R1 | 合同冻结：时区来源（I-020-001）、数字/货币落点（I-020-002）、设置归属（I-020-005）；I-003/I-004 保持 VP 冻结投影 | **待立项**（GOAL-002；I-001/I-002 required 裁决前不进方案冻结） |
