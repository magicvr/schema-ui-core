...
- **Root** `GOAL-001-timezone-number-currency-formatting`：**`active`** · 0/4（R1 已立项 GOAL-002；R2～R4 待立项）。
...
| Root Goal | `GOAL-001-timezone-number-currency-formatting` | `parent: null`；**active** · 0/4（R1 已立项 GOAL-002；R2～R4 待立项） |
...
| 阶段 | 内容 | 状态 |
|------|------|------|
| R1 | 合同冻结：时区来源（I-020-001）、数字/货币落点（I-020-002）、设置归属（I-020-005）；I-003/I-004 保持 VP 冻结投影 | **已立项**（GOAL-002 **active** · 2026-08-26；I-001/I-002/I-005 已裁决 accepted（Root D-002），合同正文已落盘，待自审/关门） |
| R2 | 时区语义：会话/用户级解析与展示（IANA / offset / auto） | 依赖 R1 | 待立项 |
