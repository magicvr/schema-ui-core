...
`01-decision/`、`02-execution/`、`03-audit/` 平铺 ledger；D-001～D-007、E-001～E-011、A-001～A-016 已记录 R3 建立、C1 审计闭合、C2 用户裁决、非阻断项修复、C2 independent re-audit 与检查点关闭，后续按编号递增。
