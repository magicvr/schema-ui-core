...
- **Root**：`GOAL-001-telegram-operator-console`，`active · 0/4`；R1 已完成，R2 `GOAL-003-r2-connection-settings` 已完成 C1～C4、当前为 `active · 4/5`；C5 self 已完成，independent 审计待进行。
...
| R2 | 连接、互斥热切换、占用位与设置页 | 进行中（GOAL-003-r2-connection-settings · active · 4/5；C1～C4 independent pass；C5 self pass，independent 待进行） |
