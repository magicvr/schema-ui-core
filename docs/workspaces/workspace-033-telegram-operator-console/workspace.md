...
- **Root**：`GOAL-001-telegram-operator-console`，`active · 0/4`；R1 已完成，R2 `GOAL-003-r2-connection-settings` 已完成 C1/C2/C3、当前为 `active · 3/5`，C4/C5 继续推进。
...
| R2 | 连接、互斥热切换、占用位与设置页 | 进行中（GOAL-003-r2-connection-settings · active · 3/5；C1/C2/C3 independent pass；C4/C5 待推进） |
