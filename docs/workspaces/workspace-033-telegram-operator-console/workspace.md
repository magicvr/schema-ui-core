...
- **Root**：`GOAL-001-telegram-operator-console`，`active · 0/4`；R1 已完成，R2 `GOAL-003-r2-connection-settings` 已完成 C1/C2、当前为 `done · 2/5`，C3 待推进。
...
| R2 | 连接、互斥热切换、占用位与设置页 | 进行中（GOAL-003-r2-connection-settings · done · 2/5；C1/C2 independent pass；C3 待推进） |
