...
- **Root**：`GOAL-001-telegram-operator-console`，`active · 0/4`；R1 已完成，R2 `GOAL-003-r2-connection-settings` 为 `active · 1/5`。
...
| R2 | 连接、互斥热切换、占用位与设置页 | 进行中（GOAL-003-r2-connection-settings · active · 1/5；C1 independent pass） |
