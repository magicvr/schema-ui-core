...
| [D-003-r1-audit-correction](01-decision/D-003-r1-audit-correction.md) | 2026-09-04 | R1 审计缺口修正 | 用户采纳并修正 A-002 F-001～F-003：补足 secret 范围、长轮询 timeout 与 polling idle/receiver 语义及矩阵 | accepted |

## 决策记录（ledger）

`01-decision/` 平铺；编号递增；未决方案不写成已接受决策。
