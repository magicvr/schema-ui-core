...
└── GOAL-004-r3-evidence-closeout [active 0/3]  · R3 证据与关门（合同 §8 harness · 双方言 · grok 独立审）
```
...
| GOAL-004-r3-evidence-closeout | R3 证据与关门（合同 §8 harness · 双方言 · Root 关门审计） | GOAL-001-graceful-shutdown-and-connection-drain | active | 0/3 | 2026-08-27 |