...
当前工作区为 `workspace-001-mvp-admin-foundation`，Root 为 `GOAL-001-mvp-admin-foundation`，canonical 范围为 `docs/workspaces/workspace-001-mvp-admin-foundation/`。工作区、Root、VP-001 与 active Charter 的 `plan_refs` / `primary_plan` / `vision_ref` 链可解析；`shared_materials_catalog: none`，本意见未把共享资料作为事实或关闭证据。
...
当前工作区 `workspace-001-mvp-admin-foundation`，Root `GOAL-001-mvp-admin-foundation`，canonical `docs/workspaces/workspace-001-mvp-admin-foundation/`。`plan_refs` / `primary_plan` = `VP-001-mvp-admin-foundation`；`shared_materials_catalog: none`，本意见未把共享资料引用当作事实或关闭证据。
...
当前工作区 `workspace-001-mvp-admin-foundation`，Root `GOAL-001-mvp-admin-foundation`，canonical `docs/workspaces/workspace-001-mvp-admin-foundation/`。`plan_refs` / `primary_plan` = `VP-001-mvp-admin-foundation`；`shared_materials_catalog: none`。范围权威为冻结 [I-PROTO-001 v0.1.3] 与登记表 [I-007-001-registry.md](attachments/I-007-001-registry.md) **v0.8.0**。
