...
- 工作区：`workspace-001-mvp-admin-foundation`；目标：`GOAL-006-r4-account-permission`；canonical：`docs/workspaces/workspace-001-mvp-admin-foundation/`。
...
- 工作区：`workspace-001-mvp-admin-foundation`（`workspace.md` 校验：`root_goal=GOAL-001-mvp-admin-foundation`、`canonical_scope=docs/workspaces/workspace-001-mvp-admin-foundation/`、`plan_refs`/`primary_plan=VP-001-mvp-admin-foundation`、`shared_materials_catalog: none`）。
...
- 工作区：`workspace-001-mvp-admin-foundation`（本审计复核 `workspace.md`：`root_goal=GOAL-001-mvp-admin-foundation`、`canonical_scope=docs/workspaces/workspace-001-mvp-admin-foundation/`、`plan_refs`/`primary_plan=VP-001-mvp-admin-foundation`、`shared_materials_catalog: none`）。
