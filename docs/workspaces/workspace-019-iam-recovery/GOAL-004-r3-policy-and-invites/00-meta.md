...
| # | 检查点 | 证据 |
|---|--------|------|
| C1 | R3 方案冻结决策落盘（本目标 D-001，含角色裁决） | 待完成 |
| C2 | 迁移 0057/0058 落地（策略行/历史/邀请表；checksum 台账 + 黄金断言同步） | 待完成 |
| C3 | 后端实施：策略域 ValidateNewPassword + 四口强制 + 配置 API；邀请域 + 管理 API + 公开激活 + 测试绿 | 待完成 |
