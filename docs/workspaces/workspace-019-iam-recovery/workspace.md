...
- **Root** `GOAL-001-iam-recovery`：**`active`** · 1/4（R1 合同冻结关门 · 2026-08-25；GOAL-002 done · A-001 self pass）。
...
| Root Goal | `GOAL-001-iam-recovery` | `parent: null`；**active** · 1/4（纲领 R1～R4；R1 已关门） |
