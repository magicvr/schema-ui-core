...
| Root Goal | `GOAL-001-digital-offer-entitlement` | `parent: null`；**done · 4/4**（第 3 次关门：R1～R4 全部关门；VP-031 closed v0.3.4） |
...
| R4 | 证据矩阵、边界核账、审计闭合与关门 | **关门**（第 3 次 · 2026-09-05 · GOAL-005 done 2/2：A-012 2 required → D-004/A-013 fixed ×2 → A-014 independent `pass` 0 required → F-001 前置加固（A-015）→ 重新关门） |
