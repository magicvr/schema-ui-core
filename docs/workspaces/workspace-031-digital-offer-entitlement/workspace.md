...
| Root Goal | `GOAL-001-digital-offer-entitlement` | `parent: null`；**active · 3/4**（R4 关门撤回：A-006 整改中） |
...
| R4 | 证据矩阵、边界核账、审计闭合与关门 | **重开**（A-006 runtime-integration `fail` 4 required——关门撤回；D-003 裁决 + 修复完成，待 closure 复审重新关门） |
