...
|----|------|--------|-------|---------|---------------|---------|------|
| （Root 关门审计台账位于 GOAL-005：第 1 次关门 A-001～A-005（A-004 independent pass）；撤回后 A-006 runtime-integration fail → 整改 → A-010 independent `pass` 0 required → A-011 重新关门——2026-09-05） | | | | | | | |
