...
|----|-------|--------|----------|--------|-------|
| GOAL-001-digital-offer-entitlement | 数字 Offer 与权益 | **active** | 1/4 | null | VP-031 lead Root。R1 关门（2026-09-05）：D-001 用户裁决 + D-002 v1.0.0 accepted（A-001～A-007 审计闭合，A-006 independent `pass` open required 0）。R2 C1～C3 关门、C4 审计循环中（GOAL-003），实施分母 = D-002 v1.2.0。 |
