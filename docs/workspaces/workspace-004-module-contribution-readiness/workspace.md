...
canonical_scope: docs/workspaces/workspace-004-module-contribution-readiness/
...
| canonical 范围 | `docs/workspaces/workspace-004-module-contribution-readiness/` | 当前工作区唯一的目标状态范围。 |
