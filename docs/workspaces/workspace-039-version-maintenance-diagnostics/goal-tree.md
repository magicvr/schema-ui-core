...
```text
GOAL-001-version-maintenance-diagnostics [done] (4/4) · 纲领容器
...
└── GOAL-005-r4-regression-and-closeout [done] (4/4) · R4 回归、证据与关门提请
```
...
|----|-------|--------|--------|----------|---------|
| GOAL-001-version-maintenance-diagnostics | Admin 版本更新、维护提示与诊断报告交付 | null | **done** | 4/4 | 2026-09-19 |
...
| GOAL-005-r4-regression-and-closeout | R4 回归、证据与关门提请 | GOAL-001-version-maintenance-diagnostics | **done** | 4/4 | 2026-09-19 |

## 说明

- Root **`done · 4/4`**。R1–R4 子目标全部 done；R4 cross 审计 required=0；用户书面确认已落盘。
