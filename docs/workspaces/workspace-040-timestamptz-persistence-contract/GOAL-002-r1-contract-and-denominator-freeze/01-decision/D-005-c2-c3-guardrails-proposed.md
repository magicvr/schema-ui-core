...
- backup：Root D-006/D-007；最小 kernel Backup/RecoveryPoint Port，SQLite/PG native provider 与 BackupService 留在 internal，metadata/verification/restore-to-new-db，rollback 优先；完整 backup product 排除。
- wire：D-003/D-005/D-009 6 位输出 + RFC3339 兼容输入；formatter/parser/fixture 清单与 VP-020 R3 接口。
