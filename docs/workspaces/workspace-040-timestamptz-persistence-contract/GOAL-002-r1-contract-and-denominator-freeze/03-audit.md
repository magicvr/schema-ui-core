...
| 核对项 | 状态 | 备注 |
|--------|------|------|
| I-040-001～003 | collecting | A-006 接受 F-I-001 closed（90 列 + catalog 72 + v1–v72）；C2/C3 的 codec、NULL/zero、checksum 追加实施、原地转换、备份与 6 位公共 wire 分母未闭合 |
| I-040-004 | open | R3 回归矩阵；R1 接口仍未登记（A-002/A-004/A-006 F-I-009） |
...
用户已完成关键方案裁决；R1 仍处于证据收集阶段。A-006 接受 F-I-001 `fixed`，A-007 响应并修正 E-006 索引；90 列、catalog 72、v1–v72 / v67–v72 扫描、`login_failures` 与 retired `records` 已处理。F-I-002～006 与 F-I-010 仍为开放 required。存在未合法闭合的 required findings 时，不得冻结 C2、不得关闭本子目标、不得将 Root R1 标 completed、不得放行 R2。
