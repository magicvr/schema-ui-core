...
└── GOAL-005-r2-backup-port-and-closeout [active] (0/3) · R2 M4 Backup Port 与阶段关门
```
...
| GOAL-005-r2-backup-port-and-closeout | R2 · Backup Port 与阶段关门（M4） | GOAL-001-timestamptz-persistence-contract | **active** | 0/3 | 2026-09-20 |
