...
|----|------|-----------------|----------|------|-------------|
| I-041-001 | required | Go codec 公共 API 形态（签名 / 错误分类 / 导出面） | A | **verified** | `01-decision/D-001-temporal-codec-api.md`；实现 `apps/api/internal/temporal/temporal.go` + 11 单测全绿（E-002）。**未经用户裁决的技术细节待独立审计复审。** |
...
| D-ID | 日期 | 标题 | 状态 | 文件 |
|------|------|------|------|------|
| D-001 | 2026-09-20 | 共享时间 codec 的公共 API 形态（I-041-001 定稿） | accepted | `01-decision/D-001-temporal-codec-api.md` |
