...
| `e2e-rerun-sqlite-admin.log` | E-008（2026-08-24）：关门后可选背书复跑，admin × sqlite Playwright 原始输出（9 passed / 1 skipped / exit 0） |
| `e2e-rerun-sqlite-mvp.log` | E-008（2026-08-24）：关门后可选背书复跑，mvp × sqlite Playwright 原始输出（9 passed / 1 skipped / exit 0） |
