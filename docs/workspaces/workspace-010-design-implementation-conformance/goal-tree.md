...
├── GOAL-015-w14-user-perspective-review [active] · W14 · 真实用户视角审视 API/Web 并落盘改进项台账（F-01～F-14）+ 整改承接（6/8）
...
│   └── GOAL-018-w14-rectification-batch-d [active] · 整改批 D · 表单与无障碍（F-11～F-14）（0/4）
```
...
**W14-批D（2026-08-17 立项，active 0/4）**：GOAL-015 下级整改子目标 GOAL-018-w14-rectification-batch-d——表单与无障碍 F-11（必填标记）/ F-12（确认对话框焦点）/ F-13（桌面表格键盘选中）/ F-14（小缺口）。五件套落盘；尚未开工（S1 冻结待推进）；批 B 后续渐进添加。
## 状态表
...
| GOAL-015-w14-user-perspective-review | W14 · 真实用户视角审视 API/Web 并落盘改进项台账（F-01～F-14）+ 整改承接（整改完成前不 done） | GOAL-001-design-implementation-conformance | active | 6/8 | 2026-08-17 |
...
| GOAL-018-w14-rectification-batch-d | W14 整改批 D：表单与无障碍（F-11 必填标记 / F-12 确认对话框焦点 / F-13 桌面表格键盘选中 / F-14 小缺口） | GOAL-015-w14-user-perspective-review | active | 0/4 | 2026-08-17 |
