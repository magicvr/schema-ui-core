...
└── GOAL-008-w7-yaml-config [active]  · W7 YAML 主配置体系（config.yaml + env 仅敏感信息）（0/5）
```
...
| GOAL-008-w7-yaml-config | W7 · YAML 主配置体系（config.yaml + env 仅敏感信息） | GOAL-001-design-implementation-conformance | active | 0/5 | 2026-08-14 |
