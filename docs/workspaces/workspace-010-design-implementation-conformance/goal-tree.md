...
└── GOAL-020-w15-user-perspective-findings [active] · W15 · 真实用户视角二期审视与体验加固台账（W15-F01～W15-F14）（6/8）
...
| GOAL-020-w15-user-perspective-findings | W15 · 真实用户视角二期审视与体验加固台账（W15-F01～W15-F14）+ 整改承接 | GOAL-001-design-implementation-conformance | active | 6/8 | 2026-08-17 |
