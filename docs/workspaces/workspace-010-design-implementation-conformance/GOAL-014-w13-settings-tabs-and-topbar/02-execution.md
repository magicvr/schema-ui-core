...
| E-013 | 2026-08-16 | T-07 列表筛选即时生效实施（即时控件 vs 提交式文本框；chips 以已提交查询为真相源） | recorded | `02-execution/E-013-t07-live-filters.md` |
| E-014 | 2026-08-16 | T-07 回归（search-form-filters 重写 / Go 0 FAIL / vitest 1037/1037 / tsc 0 / e2e admin·mvp 8/8） | recorded | `02-execution/E-014-t07-regression.md` |
| E-015 | 2026-08-16 | T-07 关门（A-005 pass；go 判定；台账与 checkpoint） | recorded | `02-execution/E-015-t07-closeout.md` |
...
- **2026-08-16**：用户点名新增 T-07 列表筛选即时生效——D-004 冻结；S2 实施（E-013）、S3 回归（E-014，全绿）、S4 关门（E-015，A-005 self pass）。
