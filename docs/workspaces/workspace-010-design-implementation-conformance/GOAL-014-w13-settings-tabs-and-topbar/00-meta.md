...
- [x] **S2 · 实施**：T-01～T-04（E-002）+ **T-05 头像上传（E-005）**；T-02 追加汉堡靠左
- [x] **S3 · 测试与回归**：相关单测/e2e 更新 + vitest 全量 + tsc + Go 全量（E-003/E-006）
- [x] **S4 · 自审与关门**：A-001/A-002 self 审计 + 台账同步（E-004/E-007）

progress: 由四个等权检查点派生（S1～S4）；当前 **4/4**（2026-08-16 二次关门；A-002 self pass；追加回归 Go 0 FAIL + vitest 1029/1029 + tsc 0 + e2e admin/mvp 8/8）。
