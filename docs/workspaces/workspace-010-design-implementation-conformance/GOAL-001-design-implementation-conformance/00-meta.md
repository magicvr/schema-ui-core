...
| W13 | GOAL-014-w13-settings-tabs-and-topbar | **done**（4/4 · 2026-08-16 关门） | 设置页功能单元 Tabs / 移动端品牌条 / 搜索框组贴合 / 顶栏明暗-语种按键对调；A-001 self pass；回归 vitest 1029/1029 + Go 0 FAIL + e2e admin/mvp 8/8；go 无影响不暂挂 |
