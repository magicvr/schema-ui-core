...
| W13 | GOAL-014-w13-settings-tabs-and-topbar | **done**（4/4 · 2026-08-16 四次关门） | 设置页功能单元 Tabs / 移动端品牌条 / 汉堡靠左 / 搜索框组贴合 / 顶栏明暗-语种按键对调 / 个人中心头像上传（迁移 0035·0036）+ 顶栏头像即时刷新修复 + 通知中心交互修正（点击即读/展开详情/未读数即时刷新）；A-001～A-004 self pass；回归 Go 0 FAIL + vitest 1037/1037 + e2e admin/mvp 全绿；go 各轮均无影响不暂挂 |
