...
| W13 | GOAL-014-w13-settings-tabs-and-topbar | **done**（4/4 · 2026-08-16 二次关门：设置页功能单元 Tabs + 移动端品牌条 + 汉堡靠左 + 搜索框组贴合 + 顶栏明暗/语种按键对调 + 个人中心头像上传（T-05）；A-001/A-002 self pass；回归 Go 0 FAIL + vitest 1029/1029 + tsc 0 + e2e admin/mvp 8/8（含 W11/W12 遗留 e2e 断言修复）；go 两轮均无影响不暂挂） |
