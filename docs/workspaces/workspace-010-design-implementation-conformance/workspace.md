...
| W29 | [GOAL-041-w29-api-web-protocol-conformance](GOAL-041-w29-api-web-protocol-conformance/00-meta.md) | **active**（5/6 · S1 分母 + S2 分类/cross + S3 custom 裁决 + S4 整改 + S5 运行时验证（35/35 分母 + 5 组合 HTTP 快照；I-006 verified、I-007 go 无影响）；待 S6 cross 关门） |
