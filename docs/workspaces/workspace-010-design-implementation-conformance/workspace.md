...
| W16 | GOAL-024-w16-user-perspective-improvements | **active**（5/8 · 2026-08-17：S1～S4 + R1 完成；批 A done，批 B GOAL-026 已渐进添加，批 C 后续） |
...
| W16-批B | GOAL-026-w16-rectification-batch-b（**GOAL-024 下级**） | **active**（2/4 · 2026-08-17：S1 方案冻结 + S2 实施完成；F02/F03/F04 代码与测试已落地，待 S3 全量回归） |
