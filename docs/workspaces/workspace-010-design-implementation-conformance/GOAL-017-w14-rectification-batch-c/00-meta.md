...
|----|------|-----------------|----------|--------------|-----------------|------|-------------|-------------|
| I-001 | non-blocking | F-09 错误码保留位置（去掉 toast 前缀后是否仍要可访问调试信息） | S2 F-09 | S1 | as-built + 方案 | open | — | 待 S1 |
| I-002 | non-blocking | F-10 失败页恢复动作（reload / 返回 / 支持链接） | S2 F-10 | S1 | as-built + 方案 | open | — | 待 S1 |
