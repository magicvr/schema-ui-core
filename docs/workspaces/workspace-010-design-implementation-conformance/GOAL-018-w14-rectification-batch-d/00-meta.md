...
|----|------|-----------------|----------|--------------|-----------------|------|-------------|-------------|
| I-001 | non-blocking | F-12 确认对话框是否复用 ModalHost 的焦点陷阱实现 | S2 F-12 | S1 | as-built + 方案 | **closed** | — | D-001：独立焦点圈实现 |
| I-002 | non-blocking | F-14 列排序清除交互（再次点击升/降后进入无排序态？） | S2 F-14 | S1 | as-built + 方案 | **closed** | — | D-001：第三次点击清除 |
