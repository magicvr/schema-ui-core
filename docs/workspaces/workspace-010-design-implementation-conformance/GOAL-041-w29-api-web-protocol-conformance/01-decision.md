...
| I-008 | required | `cross` 审计的 self 与 independent provider 是否均有可核对输出，且 required findings 已合法闭合 | S2、S6 | S2 / S6 | 按阶段写入本目标 `03-audit/A-NNN-*.md`；provider 失败不得降级冒充 | open | — | provider 按项目级决策固定 |
