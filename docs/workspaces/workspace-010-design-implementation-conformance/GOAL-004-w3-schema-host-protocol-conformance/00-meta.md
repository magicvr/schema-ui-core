...
| I-004 | required | 协议/跨边界变更的 independent provider | S2 审视、S6 关门 | 首次 cross 审视前 | 用户指定 provider；self + independent 分别落 A 台账 | verified | — | 用户指定 `grok build`；S2=A-005（independent）/A-006（self）；S6=A-008（independent）/A-007（self） |
