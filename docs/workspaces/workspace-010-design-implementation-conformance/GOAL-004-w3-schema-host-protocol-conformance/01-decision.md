...
| I-004 | required | cross 审视 provider 已指定 | S2/S6 | 首次 cross 审视前 | 用户指定并落 independent A 条目 | verified | — | 用户指定 `grok build`；S2=A-005（independent）/A-006（self）；S6=A-008（independent）/A-007（self） |
