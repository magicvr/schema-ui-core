...
| I-003 | required | 上游新协议已发布/固定并进入本仓 | S4 | S4 开始前 | 版本、provenance 与工件验证 | verified | — | 上游 H2 机器契约固定于 commit `453008d` 并 pin 入本仓（`provenance-v2.8-candidate.json`）；S4 生产实现完成（E-004）。正式 2.8.0 发布（H4）后重 pin |
