...
| Root Goal | `GOAL-001-config-export-diff-dryrun-import` | `parent: null`；**active** · 3/4（R1～R3 已关门 2026-08-30；R4 证据与关门待启动） |
...
| R3 | **dry-run + 导入**（判据 #3/4）：只读预检 + 安全导入 + 失败路径不破坏（I-025-004 用户裁决） | **已关门**（2026-08-30 · GOAL-004 done 3/3 · A-001 self `pass` · 方案 A（用户裁决 · D-002）· 18 用例 · 往返冒烟 diff `[]`） |
