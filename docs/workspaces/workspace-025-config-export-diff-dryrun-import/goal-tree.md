...
└── GOAL-005-r4-evidence-closeout（active · 2/3 · R4 证据与关门：矩阵/核账/双审/VRev-055/VP closed）
```
...
| GOAL-005-r4-evidence-closeout | R4 证据与关门 | active | 2/3 | GOAL-001-config-export-diff-dryrun-import |
