...
- **Root** `GOAL-001-wallet-prepaid-instrument`：`active` · **3/4**（R1 合同冻结 [done] → R2 主体接缝+账本入金 [done] → R3 Admin 批次面+导出 [done] → R4 证据与关门），纲领见 Root `00-meta.md`。
...
| R4 | **证据与关门**（判据 6/7）：证据矩阵 / 越界核账 / 审计闭合 | 待推进（立项 GOAL-004） |
