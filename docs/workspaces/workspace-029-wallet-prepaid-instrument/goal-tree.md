...
└── GOAL-005-my-wallet-voucher-redeem (我的钱包预付凭证自助核销入口 · active · 0/4)
...
| GOAL-005-my-wallet-voucher-redeem | 我的钱包预付凭证自助核销入口 | **active** | 0/4 | GOAL-001-wallet-prepaid-instrument | R5：已登录 identity-only HTTP + `/my-wallet` 充值入口；入账 owner_type=user；S1 待冻结 I-029-007/008 |
