...
|----|-------|--------|----------|--------|-------|
| GOAL-001-wallet-prepaid-instrument | 钱包预付资金凭证与外部主体接缝 | **active** | 4/5 | null | 2026-09-02 开区并首波关门（判据 #1～#7）；同日用户确认结构选型 A reopen（D-003 / VRev-068）：R5 = Admin 已登录自助核销 HTTP + 「我的钱包」入口（判据 #8～#10）。R1～R4 子目标维持 done；A-001～A-008 原文不改写。I-029-007/008/009 closed。GOAL-005 3/4（S4 independent A-001 pass；F-005 self 待确认） |
...
| GOAL-005-my-wallet-voucher-redeem | 我的钱包预付凭证自助核销入口 | **active** | 3/4 | GOAL-001-wallet-prepaid-instrument | R5：S1 D-002 冻结；S2 HTTP+页面；S3 回归绿；S4 independent A-001 pass（0 required）；A-002 已 fixed F-001～F-004；F-005 self 待确认；未关门 |
