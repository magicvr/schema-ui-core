...
```text
GOAL-001-wallet-prepaid-instrument (钱包预付资金凭证与外部主体接缝 · active · 5/5)
...
（R1 合同冻结 [done] → R2 主体接缝+账本入金 [GOAL-002 done] → R3 Admin 批次面+导出 [GOAL-003 done] → R4 证据与关门 [GOAL-004 done · 当时分母] → R5 Admin 自助核销 HTTP + 我的钱包入口 [GOAL-005 done]；Root / VP-029 仍 active，待再关门）
```
...
|----|-------|--------|----------|--------|-------|
| GOAL-001-wallet-prepaid-instrument | 钱包预付资金凭证与外部主体接缝 | **active** | 5/5 | null | 2026-09-02 开区并首波关门（判据 #1～#7）；同日 reopen R5。R1～R4 子目标维持 done；A-001～A-008 原文不改写。I-029-007/008/009 closed。GOAL-005 done 4/4（A-001 independent + A-003 self）。R5 子目标完成；Root / VP-029 仍 active，待再关门 |
