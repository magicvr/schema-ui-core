...
```text
GOAL-001-distribution-formalization [active 5/7]  · 分发形态正式化（cli+包 对外服务化收口：VP-022/023 go 后残余 7 项 + 方法 B 置顶）
...
|----|-------|--------|--------|----------|---------|
| GOAL-001-distribution-formalization | 分发形态正式化（cli+包 对外服务化收口） | null | active | 5/7 | 2026-08-29 |
