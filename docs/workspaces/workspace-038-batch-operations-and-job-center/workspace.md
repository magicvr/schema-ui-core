...
- Vision open required：0；`V-F126` `open · recommended`（承接动作已由 `I-038-003` 完成；闭合登记属 `/vision`）；`I-038-004`/`I-038-005` `verified`；`I-038-001`～`003` **`verified`**；`I-038-006` `deferred · non-blocking`
...
| R4 | 结果中心与体验收敛：列表/详情/进度/终态/过期/重试/取消/下载；中英文、浅色深色、加载空态错误态、可访问 | **pending**；承接 R3 移交的交互级测试与 `I-038-013` |
