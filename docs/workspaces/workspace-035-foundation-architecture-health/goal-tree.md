...
R1 对照分母 / residual 总账 / 现在修 vs 另立 [completed]
 ...
 → R3 有界业界对照 + 缺口分类 [active · C1/C2 done]
...
| GOAL-004-r3-industry-comparison | R3 有界业界对照与缺口分类 | **active** | 2/4 | GOAL-001-foundation-architecture-health | D-001 已冻结（用户裁决 A/B/C）；C1、C2 完成（13 行四格对照 + G-001～G-003 卫生锚点）；C3/C4 未完成 |
