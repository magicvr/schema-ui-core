...
|----|-------|--------|----------|--------|-------|
| GOAL-001-foundation-architecture-health | 基架架构健康评估与路线图重述 | **active** | 2/4 | null | R1、R2 completed；I-035-001/002/004/005 verified；I-035-003 属 R3；I-035-006 provider 待用户裁决 |
...
| GOAL-004-r3-industry-comparison | R3 有界业界对照与缺口分类 | **active** | 0/4 | GOAL-001-foundation-architecture-health | D-001 提议 R3 边界（含 3 项待用户确认）；C1～C4 未完成 |
