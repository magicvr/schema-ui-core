...
| 到期 required 是否已 verified / residual | S0 required **I-001 = closed**；S1 required **I-PROTO-FULL-001 = closed**（覆盖表 v1.0.1 + D-002/D-003 + A-003 复核）；I-002 = N/A；I-003/I-004 = closed | 2026-08-10 |
...
| A-003 | 2026-08-10 | self | I-PROTO-FULL-001 v1.0.1 执行分母勘误与跨区 F-001 响应 | **pass** | **0** | `03-audit/A-003-i-proto-full-errata-self.md` |
...
| **类型** | close-out |
| **verdict** | **pass** |
| **成果** | exit 1–5 满足：覆盖表 12/12 include 保持；当前 fixture 分母 320 = 318 executed + 2 local adapter excluded；本会话 vitest 569/569 + go test 全绿；8 范例页登记；docs→I-PROTO-FULL-001；无未背书「已完整支持」；I-PROTO-001 未改；E-004 记录 smoke bash 限制；A-001/A-003 open required=0；F-V018 仅阻断 VP-005 |
...
## 勘误响应（2026-08-10 · `/govern`）

- `I-PROTO-FULL-001` 已由 v1.0.0 升为 v1.0.1；当前执行分母为 **320 total = 318 executed + 2 local adapter excluded**。
- 两项 exclusion 的 id、error-envelope 差异、非域级范围性质与复审触发已写入 D-003、E-007 与覆盖表 §3/§4.2。
- A-001/A-002 原始独立意见及 verdict 保持不变；本次 self 响应见 `A-003-i-proto-full-errata-self.md`。本区 Root/VP 终态不重开。
