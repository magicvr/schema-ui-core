...
> Root：`GOAL-001-account-email-identity`（**active · 3/4**；R1/R2/R3 已关门；剩 R4 证据）
> primary_plan：`VP-018-account-email-identity`（`active` · 已解冻）

## 树

```text
GOAL-001-account-email-identity [active 3/4]        · 账号邮箱身份（绑定与校验）
...
|----|-------|--------|--------|----------|---------|
| GOAL-001-account-email-identity | 账号邮箱身份（绑定与校验） | null | active | 3/4 | 2026-08-24 |
