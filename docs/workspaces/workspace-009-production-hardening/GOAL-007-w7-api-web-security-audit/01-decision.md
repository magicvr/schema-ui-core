...
| I-002 | required | High findings 是否触发 VP-008 `go` 暂挂 | 对外宣称 go 仍有效 | 宣称前 / S2 | 用户书面裁决 | verified | 复核=F-001/F-002 闭合后恢复宣称 | D-002（暂挂）→ D-003（恢复） |
...
| D-003 | 2026-08-19 | VP-008 go 宣称恢复：F-001/F-002 闭合经双 independent 复核（A-004 + A-005） | accepted | `01-decision/D-003-w7-go-claim-restored.md` |
