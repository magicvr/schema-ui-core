...
| 到期 required 是否已 verified / residual | 是 | I-002 已由 D-002 暂挂、D-003 恢复 VP-008 go 宣称；不阻断本 close-out |
...
- A-003 两条 recommended：F-001（main.tsx 残留 inline 注释）已顺手 fixed；F-002（真实浏览器 CSP 回归）已由 E-004 真实浏览器 + 生产 CSP 响应头检查闭合。
