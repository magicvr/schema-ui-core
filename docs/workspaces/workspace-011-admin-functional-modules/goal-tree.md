...
├── GOAL-011-r3-s11-login-captcha [active]    · R3-S11 登录验证码（2/5）
...
| GOAL-011-r3-s11-login-captcha | R3-S11 · 登录验证码 | GOAL-001-admin-functional-modules | active | 2/5 | 2026-08-14 |
