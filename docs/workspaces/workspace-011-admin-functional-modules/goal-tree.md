...
├── GOAL-007-r3-s02-file-library [active]    · R3-S02 文件/附件库（统一文件管理）（0/5）
...
| GOAL-007-r3-s02-file-library | R3-S02 · 文件/附件库（统一文件管理、引用、清理） | GOAL-001-admin-functional-modules | active | 0/5 | 2026-08-14 |
