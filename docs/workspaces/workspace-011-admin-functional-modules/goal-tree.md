...
├── GOAL-009-r3-s03-system-monitoring [active] · R3-S03 系统监控与错误日志（3/5）
├── GOAL-010-r3-s04-scheduled-tasks [active]  · R3-S04 定时任务管理（0/5）
├── GOAL-011-r3-s11-login-captcha [active]    · R3-S11 登录验证码（0/5）
└── GOAL-012-r3-s12-recycle-bin [active]      · R3-S12 回收站/软删除（0/5）
```
...
| GOAL-009-r3-s03-system-monitoring | R3-S03 · 系统监控与错误日志查看 | GOAL-001-admin-functional-modules | active | 3/5 | 2026-08-14 |
| GOAL-010-r3-s04-scheduled-tasks | R3-S04 · 定时任务管理（cron 后台） | GOAL-001-admin-functional-modules | active | 0/5 | 2026-08-14 |
| GOAL-011-r3-s11-login-captcha | R3-S11 · 登录验证码 | GOAL-001-admin-functional-modules | active | 0/5 | 2026-08-14 |
| GOAL-012-r3-s12-recycle-bin | R3-S12 · 回收站/软删除管理 | GOAL-001-admin-functional-modules | active | 0/5 | 2026-08-14 |
