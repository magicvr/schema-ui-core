...
└── GOAL-008-r3-s01-data-dictionary [active]  · R3-S01 数据字典（枚举/字典管理）（1/5）
```
...
| GOAL-008-r3-s01-data-dictionary | R3-S01 · 数据字典（枚举/字典管理） | GOAL-001-admin-functional-modules | active | 1/5 | 2026-08-14 |
