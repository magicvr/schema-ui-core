...
└── GOAL-006-r2-f04-notification-center [active] · R2-F04 通知中心（站内通知）（4/5 · S4 就绪，关门待 independent）
```
...
| GOAL-006-r2-f04-notification-center | R2-F04 · 通知中心（站内通知） | GOAL-001-admin-functional-modules | active | 4/5 | 2026-08-14 |
