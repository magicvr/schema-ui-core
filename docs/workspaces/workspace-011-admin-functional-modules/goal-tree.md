...
├── GOAL-009-r3-s03-system-monitoring [active] · R3-S03 系统监控与错误日志（4/5）
...
| GOAL-009-r3-s03-system-monitoring | R3-S03 · 系统监控与错误日志查看 | GOAL-001-admin-functional-modules | active | 4/5 | 2026-08-14 |
