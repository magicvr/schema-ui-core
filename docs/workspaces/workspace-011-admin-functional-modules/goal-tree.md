...
└── GOAL-015-dict-inner-page-breadcrumb [blocked] · R4 数据字典内页 + 面包屑层级导航（2/5，等上游 P-2/P-3 协议）
```
...
| GOAL-015-dict-inner-page-breadcrumb | R4 · 数据字典内页 + 面包屑层级导航 | GOAL-001-admin-functional-modules | blocked | 2/5 | 2026-08-14 |
