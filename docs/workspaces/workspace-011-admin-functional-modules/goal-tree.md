...
├── GOAL-003-r2-f01-dashboard [active]        · R2-F01 仪表盘/控制台（生产 home）（1/5 · S1 冻结）
...
| GOAL-003-r2-f01-dashboard | R2-F01 · 仪表盘/控制台（生产 Profile home） | GOAL-001-admin-functional-modules | active | 1/5 | 2026-08-14 |
