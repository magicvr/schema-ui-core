...
└── GOAL-022-my-wallet-self-service [active] · 我的钱包（当前用户自服务页 + 顶栏入口）（3/5）
...
| GOAL-022-my-wallet-self-service | 我的钱包（当前用户自服务页 + 顶栏入口） | GOAL-001-admin-functional-modules | active | 3/5 | 2026-08-16 |
