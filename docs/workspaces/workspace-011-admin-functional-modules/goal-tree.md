...
└── GOAL-015-dict-inner-page-breadcrumb [active] · R4 数据字典内页 + 面包屑层级导航（4/5）
```
...
| GOAL-015-dict-inner-page-breadcrumb | R4 · 数据字典内页 + 面包屑层级导航 | GOAL-001-admin-functional-modules | active | 4/5 | 2026-08-14 |
