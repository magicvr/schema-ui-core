...
├── GOAL-010-r3-s04-scheduled-tasks [active]  · R3-S04 定时任务管理（3/5）
...
| GOAL-010-r3-s04-scheduled-tasks | R3-S04 · 定时任务管理（cron 后台） | GOAL-001-admin-functional-modules | active | 3/5 | 2026-08-14 |
