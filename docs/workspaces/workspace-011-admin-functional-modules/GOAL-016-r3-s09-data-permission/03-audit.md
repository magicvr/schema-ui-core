...
立项 scope：A-001 self pass + A-002 independent pass（0 required；non-blocking F-001～F-003）。可放行立项并启动 S1；I-001/I-002 仍 open，阻断完成方案冻结。独立意见不直接改 status / progress；响应和状态变更走 /govern 与用户裁决。
