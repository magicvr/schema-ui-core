...
|----|------|-----------------|----------|--------------|-----------------|------|-------------|-------------|
| I-001 | required | current/previous 键名、fail-closed、熵 | R1 方案 | R1 冻结 | R1 决策 | collecting | — | VP I-016-001 |
| I-002 | required | 密钥集合是否仅 JWT | R1 方案 | R1 冻结 | R1 决策 | collecting | — | VP I-016-002 |
| I-003 | required | 重叠窗 / kid / refresh | R2 方案 | R2 接入前 | R2 决策 | collecting | — | VP I-016-003 |
