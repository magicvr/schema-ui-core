...
- **组合编排**：VP-001～VP-004 均 **closed**；[VP-004](../vision/plans/VP-004-module-contribution-readiness.md) 已交付一方模块贡献 playbook 与 Core vs 模块归属法（权威文 [module-contribution-playbook.md](module-contribution-playbook.md)）。当前无 active 交付 VP。
