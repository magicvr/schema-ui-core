...
# 步骤
1. 读当前 `docs/workspaces/workspace-<NNN>-<slug>/workspace.md`、`00-meta.md`（含信息需求）、decision/execution 索引与 ledger 目录、`goal-tree.md`。若 workspace Root Goal/canonical 范围与目标不匹配，停止受影响写入；没有显式工作区根时只处理 legacy 隐式单工作区。
